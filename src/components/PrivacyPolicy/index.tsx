        ...
        <Box p={"1em 3em 0"} w="100%" justifyContent="center">
          <Text as="i" fontSize="lg" textAlign="justify">
            <chakra.p fontFamily={"Poppins"} fontWeight={"lighter"}>
              ...
              dichos cambios. Información que es recogida Nuestro sitio web
              podrá recoger información personal por ejemplo: Nombre,
              ...
              ofertas especiales otra información publicitaria que consideremos
              ...
              proporcione y podrán ser cancelados en cualquier momento. RUBRIT
