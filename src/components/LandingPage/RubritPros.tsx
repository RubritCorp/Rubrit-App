      ...
      <SimpleGrid columns={{ base: 1, md: 2 }} spacing={20}>
        <Stack spacing={4}>
          ...
          <Text color={"gray.500"} fontSize={"lg"}>
            Encontra la persona que mas se ajusta al trabajo que estas
            necesitando hacer, con el plus de saber que es el mejor en su rubro
            certificado por nuestra comunidad.
          </Text>
          <Stack
            spacing={4}
            divider={
          ...
          >
            <Feature
              ...
              text={
                "Compara precios, ratings y reseñas del trabajo que estas buscando"
              }
            />
            <Feature
              icon={<Check size={40} color="#6bdaae" weight="duotone" />}
              text={
                "Elegi y conecta con la persona indicada para hacer el trabajo"
              }
            />
            <Feature
              icon={<Check size={40} color="#6bdaae" weight="duotone" />}
              text={
                "Agenda a tus favoritos para volver a contactarlos cuando los necesites"
              }
            />
          </Stack>
        </Stack>
