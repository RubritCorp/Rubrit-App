  ...
  const getUserLocation = () => {
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        ...
        (error) => {
          window.alert(
            "Esta configuracion hace uso de la Geolocalizacion, por favor activarla"
          );
        }
      );
    } else {
      //para navegadores viejos o sin soporte
      console.log("No existe soporte de Geolocalizacion");
    }
  };
