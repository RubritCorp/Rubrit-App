    ...
    <Layout>
      ...
      <Container maxW="container.xl" p={"2em 6em 5em 5em"}>
        <Accordion allowToggle>
          ...
          <AccordionItem>
            ...
            <AccordionPanel pb={4}>
              Por motivos de seguridad, NO es posible cambiar el correo
              electrónico (email) con el que te has registrado en Rubrit.
            </AccordionPanel>
          </AccordionItem>
          <AccordionItem>
            <h2>
      ...
      <Container maxW="container.xl" p={"2em 6em 5em 5em"}>
        <Accordion allowToggle>
          ...
          <AccordionItem>
            <h2>
              <AccordionButton _expanded={{ bg: "light_green", color: "white" }}>
                <Box flex="1" textAlign="left">
          ...
          <AccordionItem>
            <h2>
              <AccordionButton _expanded={{ bg: "#44FEB0", color: "white" }}>
                <Box flex="1" textAlign="left">
