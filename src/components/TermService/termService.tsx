  ...
  return (
    <Layout>
      ...
      <Container maxW="container.xl" p={"2em 0"}>
        ...
        <Box p={"1em 3em 0 3em"} w="100%" justifyContent="center">
          <Text>
            Los productos de RUBRIT están optimizados para ser visualizados en
            dispositivos nativos y en definiciones responsive (en definiciones
            menores aparecerán barras de desplazamiento tanto horizontal como
            verticalmente respectivamente). Para la visualización del sitio web,
            se recomienda la utilización de Firefox 3.0 (o versiones
            posteriores) o Chrome 4.1 (o versiones posteriores). El uso de
            versiones anteriores de navegador, la utilización de un navegador no
            compatible o la desactivación de algunas propiedades, como la
            compatibilidad con Javascript o la desactivación de las cookies,
            puede reducir la funcionalidad del sitio. Si se accede al sitio
            mediante un firewall (cortafuegos) o servidor proxy, asegúrese que
            permite la recepción de cookies.
          </Text>
        </Box>
        <Flex padding={5}>
          <Text
        ...
        <Box p={"1em 3em 0 3em"} w="100%" justifyContent="center">
          <Text>
            ...
            pertenecientes y gestionados por RUBRIT. Algunos de nuestros sitios
            web podrán recoger sus propias Condiciones Particulares que, según
            los casos completarán, modificarán o sustituirán las presentes
            Condiciones Generales. La utilización de cualquiera de los sitios
            web de RUBRIT supone la comprensión y aceptación plena de todas y
            cada una de las Condiciones Generales aquí recogidas así como de las
            Condiciones Particulares que, en su caso, se establezcan en algunos
            sitios web.
          </Text>
        </Box>
        <Flex padding={5}>
        ...
        <Box p={"1em 3em 0 3em"} w="100%" justifyContent="center">
          <Text>
            ...
            incorrecto, inadecuado e ilícito cause. En cualquier momento, y sin
            necesidad de previo aviso, RUBRIT podrá denegar o retirar la
            utilización de nuestros sitios web cuando el usuario incumpla con
            estas las Condiciones Generales o con las Condiciones Particulares,
            según corresponda.
          </Text>
        </Box>
        <Flex padding={5}>
        ...
        <Box p={"1em 3em 0 3em"} w="100%" justifyContent="center">
          <Text>
            ...
            productos de manera eficiente y segura, los usuarios deberán aportar
            ciertos datos dependiendo de su rol dentro del producto, entre ellos
            pueden figurar: su nombre y apellido, documento nacional de
            identidad, o cualquier otra identificación tributaria o previsional,
            profesión o actividad comercial, dirección, número de teléfono y
            cuenta de e-mail, sin los cuales se tornaría imposible brindar los
            servicios. Por eso se requiere que éstos sean verdaderos y exactos.
            Los datos recabados por los formularios correspondientes serán
            objeto de tratamiento directamente por RUBRIT y/o terceros.
          </Text>
        </Box>
        <Flex padding={5}>
          <Text
        ...
        <Box p={"1em 3em 0 3em"} w="100%" justifyContent="center">
          <Text>
            El acceso y/o utilización de nuestros sitios web de RUBRIT es
            gratuito, excepto para aquellos servicios que así se señalen en sus
            respectivas Condiciones Particulares. La cumplimentación del
            formulario de registro es obligatoria para acceder y disfrutar de
            los servicios ofrecidos en la pagina. Así, para boletines
            informativos deberá facilitar su dirección de correo electrónico y
            para el uso de determinados servicios bajo registro deberá
            inscribirse como usuario registrado de la red de TIMBRIT pudiéndose
            identificar siempre con el mismo usuario y contraseña, aprovechando
            con ello todas las posibilidades. El no facilitar los datos
        ...
        <Box p={"1em 3em 0 3em"} w="100%" justifyContent="center">
          <Text>
            ...
            boletines informativos es el único responsable de la veracidad y
            corrección de los datos incluidos. RUBRIT se exonera de cualquier
